...
import { BROWSER_CSS } from './browser-styles'
 ...
 * Enhanced layout with sidebar TOC, toolbar, LaTeX-like typography,
 * theme toggle, scroll spy, keyboard shortcuts, and progress bar.
 *
 * When injectScript is provided (watch mode), it's inserted alongside
 * the browser interactivity script.
 */
